...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinNativeTemplate.Droid.dll" comes first in this list. */
		"XamarinNativeTemplate.Droid.dll",
		...
		"XamarinNativeTemplate.dll",
		"Plugin.Settings.Abstractions.dll",
		"Plugin.KeyChain.Abstractions.dll",
		"Plugin.Settings.dll",
		"Plugin.KeyChain.dll",
